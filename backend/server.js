...
app.use(cors({
  origin(origin, callback) {
    // Non-browser/server-to-server requests commonly omit Origin.
  ...
  allowedHeaders: ['Content-Type', 'Authorization', 'X-Admin-Key', 'X-Interview-Token']
}));
...
async function connectDatabase() {
  ...
  await initializeScheduledSessions(db);
